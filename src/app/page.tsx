          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="pl-2 sm:pl-4 md:pl-48">
              ...
              <ul className="space-y-1">
                <li>
                  <Link href="#features" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    Features
                  </Link>
                </li>
                <li>
                  <Link href="#pricing" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    Pricing
                  </Link>
                </li>
                <li>
                  <Link href="https://medium.com/@paybin" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    Blog
                  </Link>
                </li>
              </ul>
            ...
            <div className="pl-2 sm:pl-4 md:pl-48">
              ...
              <ul className="space-y-1">
                <li>
                  <Link href="https://developers.paybin.io/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    API Docs
                  </Link>
                </li>
                <li>
                  <Link href="https://status.paybin.io/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    Status
                  </Link>
                </li>
              </ul>
            ...
            <div className="pl-2 sm:pl-4 md:pl-48">
              ...
              <ul className="space-y-1">
                <li>
                  <Link href="/legal#terms" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    Terms
                  </Link>
                </li>
                <li>
                  <Link href="/legal#privacy" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    Privacy
                  </Link>
                </li>
                <li>
                  <Link href="/legal#kyc" className="text-sm text-gray-400 hover:text-gray-300 hover:underline underline-offset-2 transition-colors">
                    KYC/AML
                  </Link>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center space-x-6 mb-4 md:mb-0">
                <Link href="https://github.com/paybin" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300 transition-colors">
